...
namespace Sharpnado.HorizontalListView.Droid.Renderers.HorizontalList
{
    ...
    {
        public CenterSnapHelper(MyAndroidHorizontalListViewRenderer nativeView)
        {
            WeakNativeView = new WeakReference<MyAndroidHorizontalListViewRenderer>(nativeView);
        }
        ...
        protected WeakReference<MyAndroidHorizontalListViewRenderer> WeakNativeView { get; }
