...
{
    public partial class MyHorizontalListViewRenderer
    {
        ...
        private void EnableDragAndDrop(bool isEnabled, bool panGesture)
        {
            ...
            MyViewCell draggedViewCell = null;

            // Create a custom gesture recognizer
            if (panGesture)
            {
                _dragAndDropGesture = new UIPanGestureRecognizer(
                    gesture =>
                    {
        ...
        private void HandleDragByGestureState(
            ...
            ref MyViewCell draggedViewCell)
        {
            switch (state)
            {
                case UIGestureRecognizerState.Began:
                    ...
                    {
                        draggedViewCell = (MyViewCell)Control.CellForItem(selectedIndexPath);
                ...
                case UIGestureRecognizerState.Changed:
                    ...
                    if (changedPath != null)
                    {
                        draggedViewCell = (MyViewCell)Control.CellForItem(changedPath);
                        if (draggedViewCell == null
                ...
                case UIGestureRecognizerState.Ended:
                    ...
                    var targetViewCell = (MyViewCell)Control.CellForItem(pathTo);
